var uploadHBR = function() {
    var $mainPicture = $('#mainPicture').children('img').first(),
        e, a = 6,
        t = "Add",
        n = "Click or drag a photo here",
        i = "Click here to remove the photo",
        s = "far fa-file-image",
        d = "fa fa-times",
        ...
        function s() {
            $(e + " .remove").click(function() {
                ...
                if (parseInt($(this).data('index')) === 0) {
                    $mainPicture.attr('src', '').removeAttr('src').attr('data-src', '');
                }
            }), $(e + " .new").click(function() {
                document.getElementById("hidden_" + $(this).attr("data-index")).click()
            }), $(e + " .fileHidden").change(function() {
                i(this.files);
                if (parseInt($($(this).parent()[0]).data('index')) === 0) {
                    var reader  = new FileReader();

                    reader.addEventListener("load", function () {
                        $mainPicture.attr('src', $('meta[name="url-loader-gallery"]').attr('content')).attr('data-src', reader.result);
                        $mainPicture.unveil();
                    }, false);
    ...
    return {
        init: function(l) {
            Modernizr.draganddrop ? (void 0 !== l.max && (a = parseInt(l.max)), void 0 !== l.textNew && (t = l.textNew), void 0 !== l.textTitle && (n = l.textTitle), void 0 !== l.textTitle && (n = l.textTitle), void 0 !== l.mimes && (r = l.mimes), void 0 !== l.start && (o = l.start), function(l) {
                ...
                var c, u, f = $(l.target);
                if (f.length > 0)
                    for (f.html(""); o < a; o++) f.append((c = o, u = r.join(","), '<div class="box-drag column" draggable="true"><input type="hidden" name="bases[]" id="base64_' + c + '" data-id="' + c + '"><div class="form-group"><div class="col-md-12 no-padding uploadArea" data-index="' + c + '"><span class="new" id="new_' + c + '" title="' + n + '" data-index="' + c + '"><input type="file" class="fileHidden hidden" multiple="" accept="' + u + '" id="hidden_' + c + '" data-index="' + c + '"><i class="' + s + '"></i></span><span class="image-preview hidden" id="prev_' + c + '"><div class="remove" title="' + i + '" data-index="' + c + '"><i class="' + d + '"></i></div><img class="img-responsive" src=""></span></div></div></div>'));
